...
/***/ (function(module, exports, __webpack_require__) {
	...
	// `root.js` entry point, and it will branch depending on the environment.
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function factory(ReactComponent, isValidElement, ReactNoopUpdateQueue) {
	  ...
	  var ReactClassStaticInterface = {
	    /**
	     * This method is invoked after a components is instantiated and when it
	    ...
	    if (isAlreadyDefined) {
	      _invariant(
	        ...
	        'ReactClassInterface: You are attempting to define ' +
	          '`%s` on your components more than once. This conflict may be due ' +
	          'to a mixin.',
	        name
	      );
	    }
	  ...
	  function mixSpecIntoComponent(Constructor, spec) {
	        ...
	        if (process.env.NODE_ENV !== 'production') {
	          warning(
	            ...
	            "%s: You're attempting to include a mixin that is either null " +
	              'or not an object. Check the mixins included by the components, ' +
	    ...
	    _invariant(
	      ...
	      "ReactClass: You're attempting to " +
	        'use a components class or function as a mixin. Instead, just use a ' +
	        'regular object.'
	    );
	    _invariant(
	      !isValidElement(spec),
	      "ReactClass: You're attempting to " +
	        'use a components as a mixin. Instead, just use a regular object.'
	    );
	          ...
	          if (isAlreadyDefined) {
	            ...
	            _invariant(
	              ...
	              'ReactClass: Unexpected spec policy %s for key %s ' +
	                'when mixing in components specs.',
	              specPolicy,
	              name
	            );
	      ...
	      if (isAlreadyDefined) {
	        ...
	        _invariant(
	          ...
	          'ReactClass: You are attempting to define ' +
	            '`%s` on your components more than once. This conflict may be ' +
	            'due to a mixin.',
	          name
	        );
	      ...
	      boundMethod.bind = function(newThis) {
	        ...
	        if (newThis !== component && newThis !== null) {
	          if (process.env.NODE_ENV !== 'production') {
	            warning(
	              false,
	              'bind(): React components methods may only be bound to the ' +
	                'components instance. See %s',
	              componentName
	            );
	          }
	        } else if (!args.length) {
	          if (process.env.NODE_ENV !== 'production') {
	            warning(
	              false,
	              'bind(): You are binding a components method to the components. ' +
	    ...
	    var Constructor = identity(function(props, context, updater) {
	      ...
	      if (process.env.NODE_ENV !== 'production') {
	        warning(
	          ...
	          'Something is calling a React components directly. Use a factory or ' +
...
/***/ (function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!../node_modules/css-loader/root.js!../node_modules/less-loader/root.js!./index.less", function() {
				var newContent = require("!!../node_modules/css-loader/root.js!../node_modules/less-loader/root.js!./index.less");
...
/***/ (function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "body #root {\n  font-size: 50px;\n  color: #eeee22;\n}\n", ""]);
